...
namespace SeniorCitizenCenterMod {
    public class CustomBasePanel : GeneratedScrollPanel {
        ...
        public override void RefreshPanel() {
            Logger.logInfo(PanelHelper.LOG_CUSTOM_PANELS, "CustomHealthcarePanel.RefreshPanel");
            ...
            Logger.logInfo(PanelHelper.LOG_CUSTOM_PANELS, "CustomHealthcarePanel.RefreshPanel Done");
        }

        public void removeAllChildren() {
            foreach (UIComponent comp in this.childComponents) {
                Logger.logInfo(PanelHelper.LOG_CUSTOM_PANELS, "CustomHealthcarePanel.removeAllChildren -- Removing Child Comp: {0}", comp);
        ...
        protected override void OnButtonClicked(UIComponent comp) {
            Logger.logInfo(PanelHelper.LOG_CUSTOM_PANELS, "CustomHealthcarePanel.OnButtonClicked -- Component Clicked: {0}", comp);
